...
const subscriptionPaymentRoutes = require('./subscription_payment');
...
// Vendor Album Routes (templates + albums CRUD)
router.use('/vendor-album', vendorAlbumRoutes);
...
router.use('/subscription', subscriptionPaymentRoutes);
